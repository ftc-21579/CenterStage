...
import org.firstinspires.ftc.teamcode.common.drive.roadrunner.util.Encoder;
...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 1.00256725535; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.99939379773; // Multiplier in the Y direction
