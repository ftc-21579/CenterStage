...
public final class TwoWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -8399.614644255807; // y position of the parallel encoder (in tick units)
    ...
    public TwoWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick) {
