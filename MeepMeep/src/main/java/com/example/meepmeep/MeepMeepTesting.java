...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        botOne.runAction(botOne.getDrive().actionBuilder(new Pose2d(12, 64, Math.toRadians(90)))
                .setReversed(true)
        ...
        botTwo.runAction(botTwo.getDrive().actionBuilder(new Pose2d(12, 64, Math.toRadians(90)))
                .setReversed(true)
                .lineToY(32)
                .waitSeconds(0.5)
                .setReversed(false)
